        ...
        @else {
          <div class="data-table-wrapper"><table class="data-table"><thead><tr>
            ...
            @for(l of logs();track l.id){<tr>
              ...
              <td style="font-size:0.75rem;color:var(--color-text-muted);font-family:monospace;">{{l.actor_id.slice(0,8)}}...</td>
              <td style="font-size:0.8125rem;max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">{{l.details||'—'}}</td>
